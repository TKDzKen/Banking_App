...
file_update = pd.read_csv("Bank_File.csv")
...
def Login():
  ...
  while attempt < max_attempts:
    with open('Bank_File.csv', 'r') as Bank_File_Verify:
...
def new_account(): 
  ...
  with open('Bank_File.csv', 'r') as Bank_File:
  ...
  while True: 
    ...
    with open('Bank_File.csv', 'a', newline='') as Bank_File:
